...
bool MPRISServiceHandler::RenewLocalImageFile(const char* aImageData,
  ...
  if (!InitLocalImageFile()) {
    LOG("Fail to create a new image");
    return false;
  }
  ...
  if (NS_FAILED(rv) || written != aDataSize) {
    LOG("Fail to write an image file");
    RemoveLocalImageFile();
    return false;
  }
...
bool MPRISServiceHandler::InitLocalImageFile() {
  ...
  if (NS_FAILED(rv) || !mLocalImageFile) {
    LOG("Fail to get the image folder");
    return false;
  }
  ...
  if (NS_FAILED(rv)) {
    LOG("Fail to create an image filename");
    return false;
  }
  ...
  if (NS_FAILED(rv)) {
    LOG("Fail to create an image file");
    return false;
  }
...
void MPRISServiceHandler::RemoveLocalImageFile() {
  ...
  if (NS_FAILED(rv)) {
    LOG("Fail to check existence of the image file");
    return;
  }
  ...
  if (NS_FAILED(rv)) {
    LOG("Fail to remove the image file");
    return;
  }
