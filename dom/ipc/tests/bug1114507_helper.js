...
var gScript = SpecialPowers.loadChromeScript(SimpleTest.getTestFileURL('bug1114507_framescript.js'));
...
function setupPrefsAndPermissions() {
  SpecialPowers.pushPrefEnv({"set": [
    ...
    function() {
      ...
      setupOOPPermission(document, callback);
...
function setupOOPPermission(ctx, callback) {
  dump("%%%%%%%%%% setupOOPPermission\n");
  SpecialPowers.pushPermissions([
