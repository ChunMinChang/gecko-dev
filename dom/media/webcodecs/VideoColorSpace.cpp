...
Nullable<bool> VideoColorSpace::GetFullRange() const {
  return ToNullable(mInit.mFullRange);
}

void VideoColorSpace::ToJSON(VideoColorSpaceInit& aRetVal) { aRetVal = mInit; }
