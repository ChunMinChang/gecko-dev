...
struct cubeb_stream {
  ...
  /* Stream creation parameters:
     Set layout to CUBEB_LAYOUT_UNSUPPORTED before we support multiple channels
     on OS X. */
  cubeb_stream_params input_stream_params = { CUBEB_SAMPLE_FLOAT32NE, 0, 0, CUBEB_LAYOUT_UNSUPPORTED };
  cubeb_stream_params output_stream_params = { CUBEB_SAMPLE_FLOAT32NE, 0, 0, CUBEB_LAYOUT_UNSUPPORTED };
